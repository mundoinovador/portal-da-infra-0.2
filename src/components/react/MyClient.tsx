...
export function MyClient() {
  ...
  return (
    <div
      className="flex w-[100%] h-[100%] bg-transparent rounded-lg justify-center items-center transition-all duration-300 hover:h-[18rem] md:hover:h-[100%] hover:bg-black/50"
      onMouseEnter={() => setViewClient("flex")}
      onMouseLeave={() => setViewClient("none")}
    >
      <div
        className="flex flex-col w-fit h-fit py-4 gap-2 items-center px-[2rem] rounded-lg border border-white"
