...
const FiltrosProdutos = ({
  ...
  return (
    <div className="flex flex-col w-full">
      ...
      <div className="relative flex w-full flex-col justify-center items-center px-[10%] sm:w-fit sm:px-[12%] xl:px-[2%]">
        ...
        <div className="flex w-full flex-wrap justify-center md:justify-start gap-[1rem] lg:gap-[2rem] mb-[4rem] h-full min-h-[60vh] items-center">
          {!loadding ? (
            produtos
